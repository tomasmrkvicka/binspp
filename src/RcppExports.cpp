...
RcppExport SEXP _binspp_logpXCbeta(SEXP XSEXP, SEXP CCSEXP, SEXP alphaSEXP, SEXP omegaSEXP, SEXP AreaWSEXP, SEXP integralSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _binspp_coeff(SEXP thetaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type theta(thetaSEXP);
    rcpp_result_gen = Rcpp::wrap(coeff(theta));
    return rcpp_result_gen;
END_RCPP
}
// BirthInteractionLik
Rcpp::List BirthInteractionLik(arma::vec xprop, arma::mat CC, arma::rowvec rho0sum, arma::vec theta, arma::vec r);
RcppExport SEXP _binspp_BirthInteractionLik(SEXP xpropSEXP, SEXP CCSEXP, SEXP rho0sumSEXP, SEXP thetaSEXP, SEXP rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type xprop(xpropSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type CC(CCSEXP);
    Rcpp::traits::input_parameter< arma::rowvec >::type rho0sum(rho0sumSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type theta(thetaSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type r(rSEXP);
    rcpp_result_gen = Rcpp::wrap(BirthInteractionLik(xprop, CC, rho0sum, theta, r));
    return rcpp_result_gen;
END_RCPP
}
// DeathInteractionLik
Rcpp::List DeathInteractionLik(arma::vec xprop, int Death, arma::mat CC, arma::rowvec rho0sum, arma::vec theta, arma::vec r);
RcppExport SEXP _binspp_DeathInteractionLik(SEXP xpropSEXP, SEXP DeathSEXP, SEXP CCSEXP, SEXP rho0sumSEXP, SEXP thetaSEXP, SEXP rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type xprop(xpropSEXP);
    Rcpp::traits::input_parameter< int >::type Death(DeathSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type CC(CCSEXP);
    Rcpp::traits::input_parameter< arma::rowvec >::type rho0sum(rho0sumSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type theta(thetaSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type r(rSEXP);
    rcpp_result_gen = Rcpp::wrap(DeathInteractionLik(xprop, Death, CC, rho0sum, theta, r));
    return rcpp_result_gen;
END_RCPP
}
// pCClik
double pCClik(arma::vec thetaprop, arma::mat CC);
RcppExport SEXP _binspp_pCClik(SEXP thetapropSEXP, SEXP CCSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type thetaprop(thetapropSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type CC(CCSEXP);
    rcpp_result_gen = Rcpp::wrap(pCClik(thetaprop, CC));
    return rcpp_result_gen;
END_RCPP
}
// pCClik2
Rcpp::List pCClik2(arma::vec thetaprop, arma::mat CC);
RcppExport SEXP _binspp_pCClik2(SEXP thetapropSEXP, SEXP CCSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type thetaprop(thetapropSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type CC(CCSEXP);
    rcpp_result_gen = Rcpp::wrap(pCClik2(thetaprop, CC));
    return rcpp_result_gen;
END_RCPP
}
// logpCCtemp
double logpCCtemp(arma::mat X, arma::mat CC, double alpha, double omega, double numratio, double AreaW, double integral);
RcppExport SEXP _binspp_logpCCtemp(SEXP XSEXP, SEXP CCSEXP, SEXP alphaSEXP, SEXP omegaSEXP, SEXP numratioSEXP, SEXP AreaWSEXP, SEXP integralSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< double >::type omega(omegaSEXP);
    Rcpp::traits::input_parameter< double >::type numratio(numratioSEXP);
    Rcpp::traits::input_parameter< double >::type AreaW(AreaWSEXP);
    Rcpp::traits::input_parameter< double >::type integral(integralSEXP);
    rcpp_result_gen = Rcpp::wrap(logpCCtemp(X, CC, alpha, omega, numratio, AreaW, integral));
    return rcpp_result_gen;
END_RCPP
}
// dgenpois_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_binspp_logpXCbeta", (DL_FUNC) &_binspp_logpXCbeta, 6},
    {"_binspp_coeff", (DL_FUNC) &_binspp_coeff, 1},
    {"_binspp_BirthInteractionLik", (DL_FUNC) &_binspp_BirthInteractionLik, 5},
    {"_binspp_DeathInteractionLik", (DL_FUNC) &_binspp_DeathInteractionLik, 6},
    {"_binspp_pCClik", (DL_FUNC) &_binspp_pCClik, 2},
    {"_binspp_pCClik2", (DL_FUNC) &_binspp_pCClik2, 2},
    {"_binspp_logpCCtemp", (DL_FUNC) &_binspp_logpCCtemp, 7},
